...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        return require("@rspack/resolver-binding-android-arm64");
      } catch (e) {
        loadErrors.push(e);
      }
      ...
      try {
        return require("@rspack/resolver-binding-android-arm-eabi");
      } catch (e) {
        loadErrors.push(e);
      }
    } else {
    ...
    if (process.arch === "x64") {
      ...
      try {
        return require("@rspack/resolver-binding-win32-x64-msvc");
      } catch (e) {
        loadErrors.push(e);
      }
      ...
      try {
        return require("@rspack/resolver-binding-win32-ia32-msvc");
      } catch (e) {
        loadErrors.push(e);
      }
      ...
      try {
        return require("@rspack/resolver-binding-win32-arm64-msvc");
      } catch (e) {
        loadErrors.push(e);
      }
    } else {
    ...
    try {
      return require("@rspack/resolver-binding-darwin-universal");
    } catch (e) {
      loadErrors.push(e);
    }
    if (process.arch === "x64") {
      ...
      try {
        return require("@rspack/resolver-binding-darwin-x64");
      } catch (e) {
        loadErrors.push(e);
      }
    } else if (process.arch === "arm64") {
      ...
      try {
        return require("@rspack/resolver-binding-darwin-arm64");
      } catch (e) {
        loadErrors.push(e);
      }
    } else {
    ...
    if (process.arch === "x64") {
      ...
      try {
        return require("@rspack/resolver-binding-freebsd-x64");
      } catch (e) {
        loadErrors.push(e);
      }
    } else if (process.arch === "arm64") {
      ...
      try {
        return require("@rspack/resolver-binding-freebsd-arm64");
      } catch (e) {
        loadErrors.push(e);
      }
    } else {
    ...
    if (process.arch === "x64") {
      if (isMusl()) {
        ...
        try {
          return require("@rspack/resolver-binding-linux-x64-musl");
        } catch (e) {
          loadErrors.push(e);
        }
      } else {
        ...
        try {
          return require("@rspack/resolver-binding-linux-x64-gnu");
        } catch (e) {
          loadErrors.push(e);
        }
      }
      ...
      if (isMusl()) {
        ...
        try {
          return require("@rspack/resolver-binding-linux-arm64-musl");
        } catch (e) {
          loadErrors.push(e);
        }
      } else {
        ...
        try {
          return require("@rspack/resolver-binding-linux-arm64-gnu");
        } catch (e) {
          loadErrors.push(e);
        }
      }
      ...
      if (isMusl()) {
        ...
        try {
          return require("@rspack/resolver-binding-linux-arm-musleabihf");
        } catch (e) {
          loadErrors.push(e);
        }
      } else {
      ...
      if (isMusl()) {
        ...
        try {
          return require("@rspack/resolver-binding-linux-riscv64-musl");
        } catch (e) {
          loadErrors.push(e);
        }
      } else {
        ...
        try {
          return require("@rspack/resolver-binding-linux-riscv64-gnu");
        } catch (e) {
          loadErrors.push(e);
        }
      }
      ...
      try {
        return require("@rspack/resolver-binding-linux-ppc64-gnu");
      } catch (e) {
        loadErrors.push(e);
      }
      ...
      try {
        return require("@rspack/resolver-binding-linux-s390x-gnu");
      } catch (e) {
        loadErrors.push(e);
      }
    } else {
    ...
    if (process.arch === "arm64") {
      ...
      try {
        return require("@rspack/resolver-binding-linux-arm64-ohos");
      } catch (e) {
        loadErrors.push(e);
      }
      ...
      try {
        return require("@rspack/resolver-binding-linux-x64-ohos");
      } catch (e) {
        loadErrors.push(e);
      }
    } else if (process.arch === "arm") {
      ...
      try {
        return require("@rspack/resolver-binding-linux-arm-ohos");
      } catch (e) {
        loadErrors.push(e);
      }
    } else {
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  if (!nativeBinding) {
    try {
      nativeBinding = require("@rspack/resolver-binding-wasm32-wasi");
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
        loadErrors.push(err);
      }
